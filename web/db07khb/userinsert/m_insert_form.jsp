...
<body>
<%@ include file="/dev50db/module/top.jsp" %>
<%@ include file="/dev50db/module/left.jsp" %>
...
<button type="button" class="navyBtn"
        onClick="location.href='<%=request.getContextPath()%>/dev50db/msearch/m_search_list.jsp';">회원 검색
</button>
<br><br>
<%= request.getRequestURI() %> <br>
<form action="<%= request.getContextPath() %>/dev50db/minsert/m_insert_action.jsp" method="post">
    <table border="1">
        <tr>
            <td>아이디</td>
...
<%@ include file="/dev50db/module/hadan.jsp" %>
</body>
</html>